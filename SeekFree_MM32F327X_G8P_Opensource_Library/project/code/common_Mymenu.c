...
//或者减1加2？
float speed_min = 90.0f;                                                          // 弯道最低速度（编码器单位，脉冲/5ms）
float speed_decision_k = 1.0f;                                                    // 速度决策系数（1=标准，>1弯道更慢）
float v_max_straight = 160.0f;                                                    // 直道目标速度（编码器单位）
float v_max_straight_start = 135.0f;                                              // 直道恢复前0.2s过渡速度
float v_max_turn_cancel = 135.0f;        //                                            // 弯道超时目标速度（编码器单位）
float v_max_turn = 115.0f;                                                        // 弯道基础速度（编码器单位）
