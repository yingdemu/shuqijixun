...
#define MT9V03X_COF_IIC_SCL     ( E0  )                                         // 总钻风 IIC-SCL 引脚
#define MT9V03X_COF_IIC_SDA     ( E1  )                                         // 总钻风 IIC-SDA 引脚
...
#define MT9V03X_VSYNC_PIN       ( E6           )                                // 场中断引脚
#define MT9V03X_VSYNC_IRQN      ( EXTI9_5_IRQn )                                // 中断号

#define MT9V03X_DATA_PIN        ( E8 )                                          // 数据引脚 这里是 只能是 GPIOx0 或者 GPIOx8 开始 连续八个引脚例如 F0-F7
...
// 摄像头默认参数配置 在此修改摄像头配置
//--------------------------------------------------------------------------------------------------
#define MT9V03X_W               ( 141 )                                        // 图像宽度     范围 [1-752]
