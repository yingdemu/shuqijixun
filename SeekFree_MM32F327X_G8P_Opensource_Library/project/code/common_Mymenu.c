...
float v_max_turn_cancel = 170.0f;        //                                            // 弯道超时目标速度（编码器单位）
float v_max_turn = 170.0f;                                                        // 弯道基础速度（编码器单位）
float v_max_turn_start = 170.0f;         //                                              // 弯道开始时减速速度（编码器单位）
float v_warning = 170.0f;                                                              // 中端黑点警告速度（快出界时降到此速度）
//-----发车标志位-----
